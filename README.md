# Face Mask Detector with Python, OpenCV and YOLOv3/4
 ...
 This repository consists of a notebook with detailed steps in training a custom mask detector model, as well as an inference python script to run detection of images and video files with the trained model.
